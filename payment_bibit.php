...
if ($order_id) {
    $stmt = $conn->prepare("SELECT o.*, b.nama AS item_name, b.harga AS item_price, b.gambar AS item_image FROM orders_bibit o JOIN bahan_bakubibit b ON o.bahan_id = b.id WHERE o.id = ?");
...
<body>
    ...
    <div class="content">
        ...
        <form method="POST" action="invoice_paymentbibit.php">
