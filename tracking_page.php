...
if ($tracking_number) {
    ...
    $stmt = $conn->prepare("SELECT st.tracking_number, st.status, st.last_updated, o.full_name AS sender_name, o.company_name AS receiver_name, o.shipping_address, o.city, o.province FROM shipping_tracking st JOIN orders o ON st.tracking_number = o.tracking_number WHERE st.tracking_number = ?");
